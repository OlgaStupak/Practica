...
class Ui_Dialog3(object):
    def open_naklon(self):
        os.system('python naklon.py')
    def open_naklonN(self):
        os.system('python naklonN.py')
...
"font: 700 18pt \"Century Gothic\";")
        icon = QIcon()
        self.pushButton.clicked.connect(self.open_naklon)
...
"font: 700 18pt \"Century Gothic\";")
        icon1 = QIcon()
        self.pushButton.clicked.connect(self.open_naklonN)
        self.pushButton.clicked.connect(Dialog.close)
