...
class Ui_Dialog(object):
    def open_prised(self):
        os.system('python prised.py')
    def open_prisedN(self):
        os.system('python prisedN.py')
...
"font: 700 18pt \"Century Gothic\";")
        ...
        self.pushButton.clicked.connect(self.open_prised)
...
"font: 700 18pt \"Century Gothic\";")
        ...
        self.pushButton_2.clicked.connect(self.open_prisedN)
